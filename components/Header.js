...
const Header = () => {
  return (
    <header className="flex justify-between items-center flex-col sm:flex-row m-5">
      <div className="flex flex-grow justify-between items-center max-w-2xl">
        <Headeritems title={"Home"} Icon={HomeIcon} />
        <Headeritems title={"Home"} Icon={BoltIcon} />
        <Headeritems title={"Home"} Icon={CheckBadgeIcon} />
        <Headeritems title={"Home"} Icon={ListBulletIcon} />
        <Headeritems title={"Home"} Icon={UserIcon} />
        <Headeritems title={"Home"} Icon={MagnifyingGlassIcon} />
      </div>
      <div className="mx-5">
        <svg
          viewBox="0 -2 61 24"
